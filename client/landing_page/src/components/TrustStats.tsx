...
export const TrustStats: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-white relative border-y border-slate-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 max-w-4xl mx-auto p-4 rounded-xl bg-brand-50/60 border border-brand-100 flex items-start gap-3 text-xs text-slate-600">
          <Info className="w-4 h-4 text-brand-600 shrink-0 mt-0.5" />
          <p>
            <strong className="font-semibold text-slate-800">Transparency Note:</strong> Amman Communications operates as an independent private documentation consultancy. We provide professional deed drafting, pre-audit checks, and application filing assistance to simplify regulatory compliance.
          </p>
        </div>
      </div>
    </section>
