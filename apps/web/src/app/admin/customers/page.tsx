              ...
              <table className="w-full text-left text-sm text-gray-600">
                <thead className="bg-gray-50 text-xs uppercase font-semibold tracking-wider text-gray-500 border-b border-gray-200">
                  <tr>
                    ...
                    <th scope="col" className="px-6 py-3.5 whitespace-nowrap min-w-[160px]">Customer</th>
                    <th scope="col" className="px-6 py-3.5 whitespace-nowrap min-w-[200px]">Email Address</th>
                    <th scope="col" className="px-6 py-3.5 whitespace-nowrap min-w-[170px]">Phone Number</th>
                    <th scope="col" className="px-6 py-3.5 whitespace-nowrap min-w-[140px]">Account Status</th>
                    <th scope="col" className="px-6 py-3.5 whitespace-nowrap text-center min-w-[110px]">Applications</th>
                    <th scope="col" className="px-6 py-3.5 whitespace-nowrap text-center min-w-[100px]">Documents</th>
                    <th scope="col" className="px-6 py-3.5 whitespace-nowrap min-w-[140px]">Registered Date</th>
                    <th scope="col" className="px-6 py-3.5 whitespace-nowrap text-right min-w-[140px]">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 bg-white">
                  {customers.map((cust) => (
                    <tr key={cust.id} className="hover:bg-gray-50/80 transition">
                      {/* Checkbox */}
                      <td className="px-4 py-4 w-10 text-center whitespace-nowrap">
                        <input
                          type="checkbox"
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <button
                          ...
                          className="text-left font-semibold text-gray-900 hover:text-emerald-800 hover:underline cursor-pointer block"
                        >
                          {cust.name}
                        </button>
                      ...
                      {/* Email */}
                      <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-700">{cust.email}</td>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-300 py-2 pl-9 pr-3.5 text-sm text-gray-900 focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-600/20"
                  />
                </div>
              </div>
            ...
            <div className="p-6 space-y-4 text-sm text-gray-700">
              <div className="grid grid-cols-2 gap-4 rounded-lg border border-gray-200 bg-gray-50 p-4">
                ...
                <div>
                  ...
                  <p className="mt-0.5 font-medium text-gray-900 flex items-center gap-1.5">
                    <Phone className="h-3.5 w-3.5 text-gray-400 shrink-0" />
                    {viewingCustomer.phone || <span className="text-gray-400 italic font-normal">Not provided</span>}
                  </p>
                </div>
                <div>
                ...
                <div className="col-span-2 border-t border-gray-200 pt-3">
                  ...
                  <p className="mt-0.5 text-xs font-semibold text-gray-900">
                    {viewingCustomer._count?.applications || 0} Applications / {viewingCustomer._count?.documents || 0} Documents
                  </p>
                </div>
              </div>
