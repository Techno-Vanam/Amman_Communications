  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4 font-sans pb-1">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <StatCard
          label={t('pay.statTotal')}
          value={formatCurrency(totalPaidSum)}
          sub={t('pay.statSuccessSub')}
          icon={CheckCircle2}
          variant="emerald"
        />
        <StatCard
          label={t('pay.statPending')}
          value={formatCurrency(pendingPaymentsSum)}
          sub={t('pay.statPendingSub')}
          icon={Clock}
          variant="rose"
        />
        <StatCard
          label={t('pay.statSuccess')}
        ...
        />
        <StatCard
          label={t('pay.statRefunds')}
          value={totalTransactionsCount}
          sub={t('pay.statRefundsSub')}
          icon={Receipt}
          variant="indigo"
        />
      </div>
        ...
        <div className="p-4 sm:p-5 pb-2 flex flex-col lg:flex-row items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
            ...
            >
              ...
              <span>{getDateTimelineLabel()}</span>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end sm:justify-start">
            ...
            >
              ...
              <span>{isExportingPDF ? 'Generating PDF...' : t('pay.exportPdfBtn')}</span>
            </button>
          </div>
        </div>
