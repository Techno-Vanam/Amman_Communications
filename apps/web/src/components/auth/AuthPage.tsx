  ...
  const brandingPanel = (
    <div className="hidden md:flex lg:w-1/2 bg-gradient-to-br from-brand-700 via-brand-800 to-[#062117] p-6 sm:p-10 lg:p-14 text-white flex flex-col justify-between relative overflow-hidden self-stretch w-full min-h-[280px] sm:min-h-[360px] lg:min-h-[400px]">
      ...
      <div className="relative z-10 flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-white/15 border border-white/20 flex items-center justify-center shadow-xs shrink-0">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[9px] sm:text-[10px] font-semibold tracking-widest text-brand-200 uppercase leading-tight mt-0.5">
            Communications
          </span>
        </div>
      </div>
      ...
      {/* Central Visual Card */}
      <div className="relative z-10 my-6 sm:my-auto max-w-lg bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-white/20 shadow-xl space-y-3 sm:space-y-4">
      ...
      {/* Footer Info */}
      <div className="relative z-10 text-[11px] sm:text-xs text-white/60 pt-4 flex items-center justify-between">
